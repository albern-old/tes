...
<body>
    <div class="container">
        ...
        <ul class="nav nav-tabs" id="myTab" role="tablist">
            ...
            <!-- TAB HUTANG YANG DITAMBAHKAN -->
            <li class="nav-item" role="presentation">
                <button class="nav-link" id="tabHutang-tab" data-bs-toggle="tab" data-bs-target="#tabHutang"
                    type="button" role="tab" aria-controls="tabHutang" aria-selected="false">
                    <strong><i class="fas fa-file-invoice-dollar"></i> Hutang Pembelian</strong>
                </button>
            </li>
        </ul>
        ...
        <div class="tab-content mt-3" id="myTabContent">
            ...
            <!-- TAB HUTANG PEMBELIAN - POSISI YANG BENAR -->
            <div class="tab-pane fade" id="tabHutang" role="tabpanel" aria-labelledby="tabHutang-tab">
                <h3>Hutang Pembelian</h3>
                <p class="text-muted">Kelola hutang pembelian barang dari pemasok.</p>
                <hr>

                <!-- Ringkasan Hutang -->
                <div id="hutangSummary"></div>

                <!-- Form Tambah Hutang -->
                <div class="card mb-4">
                    <div class="card-header bg-warning text-dark">
                        <strong><i class="fas fa-plus"></i> Tambah Hutang Pembelian</strong>
                    </div>
                    <div class="card-body">
                        <form id="formTambahHutang">
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="hutangBarang" class="form-label">Pilih Barang</label>
                                        <select class="form-select" id="hutangBarang" name="barang_id" required>
                                            <option value="">-- Pilih Barang --</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="hutangJumlah" class="form-label">Jumlah</label>
                                        <input type="number" class="form-control" id="hutangJumlah" name="jumlah"
                                            min="1" required>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="hutangHargaTotal" class="form-label">Total Hutang (Rp)</label>
                                        <input type="number" class="form-control" id="hutangHargaTotal"
                                            name="harga_total" min="1" required>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="mb-3">
                                        <label for="hutangJatuhTempo" class="form-label">Tanggal Jatuh Tempo
                                            (Opsional)</label>
                                        <input type="date" class="form-control" id="hutangJatuhTempo"
                            ...
                            <div class="mb-3">
                                <label for="hutangKeterangan" class="form-label">Keterangan</label>
                                <textarea class="form-control" id="hutangKeterangan" name="keterangan" rows="2"
                                    placeholder="Keterangan hutang pembelian"></textarea>
                            </div>

                            <div class="text-center">
                                <button type="button" class="btn btn-warning btn-lg" id="tambahHutangBtn">
                                    <i class="fas fa-save"></i> Simpan Hutang
                                </button>
                            </div>
                        </form>
                    </div>
                ...
                <!-- Daftar Hutang -->
                <h4>Daftar Hutang Pembelian</h4>
                <div id="daftarHutangContainer" class="row">
                    <!-- Data hutang akan di-load via JavaScript -->
                </div>
            </div>
